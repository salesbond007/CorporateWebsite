...
const reasons: Reason[] = [
  ...
  },
  {
    ...
    body: "テレアポや飛び込み営業とは違い、紹介を通じてつながるからこそ、初回の商談から信頼関係があります。警戒されることなく本題に入れるため、話がスムーズに進みます。結果として、質の高い商談を実現します。",
    bodyHighlights: ["質の高い商談"],
    image: "https://i.imgur.com/pYa3Hwt.png",
  },
];
