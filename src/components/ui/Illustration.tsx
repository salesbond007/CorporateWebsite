    ...
    <svg viewBox="0 0 400 400" className="h-full w-full">
      <defs>
        <linearGradient id="ab-grad" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#D07189" />
          <stop offset="100%" stopColor="#7A1E35" />
        </linearGradient>
      </defs>
      <circle cx="200" cy="200" r="160" fill="url(#ab-grad)" opacity="0.18" />
      <circle cx="200" cy="200" r="110" fill="none" stroke="#7A1E35" strokeWidth="1.5" opacity="0.4" />
      <path
        ...
        strokeWidth="2"
      />
      <circle cx="80" cy="260" r="6" fill="#7A1E35" />
      <circle cx="320" cy="140" r="6" fill="#7A1E35" />
      <rect x="170" y="170" width="60" height="60" rx="12" fill="#7A1E35" opacity="0.9" />
    </svg>
  );
}
